...
v1.0.1
*/
if(!class_exists('Pisol_Smdsw_review')){
class Pisol_Smdsw_review{
...
new Pisol_Smdsw_review('Shipping method dropdown for WooCommerce', 'shipping-method-dropdown-for-woocommerce');
}